...
public interface PlayerDataService {
    ...
    /**
     * Get a collection of all known offline players. Currently online players
     * may or may not be included, but if they are, they will be included in
     * OfflinePlayer form.
     *
    ...
    /**
     * Locally look up the UUID of an offline player based on their name. If no
     * local player with the name was found, an offline-mode UUID is returned.
     *
    ...
    interface PlayerReader extends AutoCloseable {
        ...
        /**
         * Check whether the player has played before. If the player has not
         * played before, most of the rest of the fields will have their default
         * values. If the player has played before, some fields may still not
         * have meaningful values, depending on the data.
         *
