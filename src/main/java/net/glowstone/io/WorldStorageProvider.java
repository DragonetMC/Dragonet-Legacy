...
public interface WorldStorageProvider {
    ...
    /**
     * Get the {@link ChunkIoService} for this world, to be used for reading and
     * writing chunk data.
     *
    ...
    /**
     * Get the {@link PlayerDataService} for this world, to be used for reading
     * and writing data for online and offline players.
     *
