...
public class JRakLibInterface implements ServerInstance{
    ...
    @Override
    public void exceptionCaught(String message, String clazz) {
        manager.getServer().getLogger().error("JRakLib caught an exception in (" + clazz + "): " + message);
    }
}
